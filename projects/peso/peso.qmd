...
subtitle: "Setbacks and Opportunities"
date: "Nov 22, 2024"
...
p1_interactive <- plot_ly(
  ...
  title = "Foreign Reserves To Foreign Debt (1980 - 2010)",
  xaxis = list(title = 'Years'),
  yaxis = list(title = 'Foreign Reserves To Foreign Debt Ratio'),
  hovermode = "x unified",
  shapes = list(
    list(
      type = "rect",
