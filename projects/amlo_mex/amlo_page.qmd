---
title: "How MORENA Came to Control Mexico"
...
```{r}
# Interactive deputies plot
# p1_interactive <- deputies2024 |>
#   ggplot(aes(x = x, y = y)) +
#   geom_parliament_seats_interactive(
#     size = 7, 
#     aes(color = party, tooltip = party, data_id = party)  # Add tooltip and data_id
#   ) + 
#   scale_colour_manual(values = coalition_colors) +  # coalition colors
#   theme_void() +
#   theme(legend.position = "null")

# # Interactive senate plot
# p2_interactive <- senate2024 |>
#   ggplot(aes(x = x, y = y)) +
#   geom_parliament_seats_interactive(
#     size = 14, 
#     aes(color = party, tooltip = party, data_id = party)  # Add tooltip and data_id
