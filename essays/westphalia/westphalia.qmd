...
**Figure 1** *Total lobbying spending in the United States from 1998 to 2023 (in billion U.S. dollars)*
...
read_excel("lobby.xlsx", sheet = "Data") |> 
  slice(-c(1 , 2)) |> 
  clean_names() |> 
  rename(year = u_s_total_lobbying_spending_1998_2023,
         value = x2) |> 
  ...
  geom_text(aes(label = round(value, digit = 1)), 
          vjust = 1.1, 
          hjust = 1.5, 
          nudge_x = 0.5, 
          nudge_y = 0.2, 
          ...
          color = "blue") +
  theme_light() +
  scale_x_continuous(breaks = seq(1998, 2023, 
                                  by = 1)) +
  theme(axis.text.x = element_text(angle = 45, 
                                   vjust = 1, 
                                   hjust = 1)) +
  labs(y = "Spending in billions of USD",
       x = "Years")
