...
We make a basic model predicting whether the opening will be sicilian in a parituclar game. The results are below.
...
A model with more predictive power would have a dark shaded region on the bottom left and another on the top right of the graph. We do not find this in the graph below wo se can say that this model is not capturing the likelihood of Sicilian opening taking place.
